...
public class StorePointsAccountDAO {
...
//	}
	...
	public  Account getAccount(String storeDBHost, String storeDBName,String primaryContactId) {
		
		GetStorePointsRESTServiceClient getStorePointsRESTServiceClient = new GetStorePointsRESTServiceClient( storeDBHost,  storeDBName, primaryContactId);
		getStorePointsRESTServiceClient.makeGetServiceCall();
		
		return getStorePointsRESTServiceClient.getAccount(); 
	}
