...
public class StorePointsUsersDAO {
	...
	public static User getUser(String userContactId){
		
		GetUserRESTServiceClient getUserRESTServiceClient = new GetUserRESTServiceClient(userContactId);
		
		getUserRESTServiceClient.makeGetServiceCall();
		
		return getUserRESTServiceClient.getUser();
