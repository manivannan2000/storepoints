...
public class GetStoresSPRESTServiceClient extends AbstractSPRESTServiceClient {
	...
	public GetStoresSPRESTServiceClient(List<Store> stores, boolean revisionOnly){
		this.stores= stores;
