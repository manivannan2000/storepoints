...
public class AddStoreSPRESTServiceClient extends AbstractSPRESTServiceClient {
	...
	public AddStoreSPRESTServiceClient(Store store) {
		this.store= store;
	}
	...
	protected String getSPRESTPostData() {
		...
		GetStoresSPRESTServiceClient getStoresSPRESTServiceClient= new GetStoresSPRESTServiceClient(storesList, true);
