...
BusyBox.prototype.RenderContent = function()
{
	...
	var style = " style=' position: absolute; background:none;' ";
	
	doc.open();
	doc.writeln("<body ondragstart='return false;' style='margin: 0px; background: none;'" );
	//doc.writeln("   <div id='" + this.DivID + "' align=center " + style + ">");
	
			
		
		doc.writeln("   <div id='" + this.DivID + "' align=center " + "style='margin:0; background: none; position:relative;'" +">");
			doc.writeln("   <div id='" + this.DivID + "' align=center " + "style='top:12px; left:17px;color:#fff; font-family:arial; font-size:14px; font-weight:bold; background: none; position:absolute; z-index:9999'" +">");
			doc.writeln("      <label>Uploading... Please wait...</label>");
		doc.writeln("   </div>");
...
{	
	...
	this.IFrame.style.width = '209px';
	this.IFrame.style.height = '84px';
}
